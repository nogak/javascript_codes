...
function draw_cell(base_x, base_y, face_num){
    let count_1 = 0;
    let count_2 = 0;
    console.log(face[0][0][0]);
    // 中身
    for(let i=base_y; i<=base_y+cell_size*2; i+=cell_size){
        for(let j=base_x; j<=base_x+cell_size*2; j+=cell_size){
            if(face[face_num][count_2][count_1] == 1){
                ctx.fillStyle = 'green'
            }else if(face[face_num][count_2][count_1] == 2){
                ctx.fillStyle = 'white'
            }else if(face[face_num][count_2][count_1] == 3){
                ctx.fillStyle = 'yellow'
            }else if(face[face_num][count_2][count_1] == 4){
                ctx.fillStyle = 'orange'
            }else if(face[face_num][count_2][count_1] == 5){
                ctx.fillStyle = 'red'
            }else if(face[face_num][count_2][count_1] == 6){
                ctx.fillStyle = 'blue'
            }
