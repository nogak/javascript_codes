...
function rotate(){
    ...
    if(right_pressed && frame_counter > 10 && grid_focus){
        ...
        // 上面回転
        if(focus[2] == 0){
            face[1][0] = [buf_face[1][0][2], buf_face[1][1][2], buf_face[1][2][2]];
            face[1][2] = [buf_face[1][0][0], buf_face[1][1][0], buf_face[1][2][0]];
            face[1][1][0] = buf_face[1][0][1];
            face[1][1][2] = buf_face[1][2][1];
        }
        // 底面回転
        if(focus[2] == 2){
            face[2][2] = [buf_face[2][0][2], buf_face[2][1][2], buf_face[2][2][2]];
            face[2][0] = [buf_face[2][0][0], buf_face[2][1][0], buf_face[2][2][0]];
            face[2][1][2] = buf_face[2][0][1];
            face[2][1][0] = buf_face[2][2][1];
        }
        ...
        // 底面回転
        if(focus[2] == 2){
            face[2][0] = [buf_face[2][0][2], buf_face[2][1][2], buf_face[2][2][2]];
            face[2][2] = [buf_face[2][0][0], buf_face[2][1][0], buf_face[2][2][0]];
            face[2][1][0] = buf_face[2][0][1];
            face[2][1][2] = buf_face[2][2][1];
        }
        // 上面回転
        if(focus[2] == 0){
            face[1][2] = [buf_face[1][0][2], buf_face[1][1][2], buf_face[1][2][2]];
            face[1][0] = [buf_face[1][0][0], buf_face[1][1][0], buf_face[1][2][0]];
            face[1][1][2] = buf_face[1][0][1];
            face[1][1][0] = buf_face[1][2][1];
        }
    }
}
